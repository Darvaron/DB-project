...
public class EventoDAO {
    ...
    public void incluirEvento() throws CaException {
        try {
            ...
            prepStmt.setDate(6, f_cancelmax);
            prepStmt.setString(7, ev.getN_lugar());
            prepStmt.setString(8, ev.getO_descripcion());
            prepStmt.setString(9, ev.getN_nombrev());
            prepStmt.setDate(10, f_inic);
            prepStmt.setDate(11, f_fin);
            prepStmt.setDate(12, f_maxins);
            prepStmt.setString(13, ev.getO_descripcion());
            prepStmt.setInt(14, ev.getQ_cupodisp());
            prepStmt.setDate(15, f_cierre);
    ...
    public void actualizarEvento() throws CaException {
        try {
            ...
            prepStmt = conexion.prepareCall(strSQL);
            prepStmt.setInt(1, ev.getK_code());
            prepStmt.executeUpdate();
            prepStmt.close();
            ServiceLocator.getInstance().commit();
