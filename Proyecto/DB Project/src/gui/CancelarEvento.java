...
public class CancelarEvento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Identificaion del vento");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, -1, 20));
        getContentPane().add(id, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 70, 190, -1));
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 120, 30, 10));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        evenReal= eventoDao.getEv();
        
        evenReal.setK_code(Integer.parseInt(id.getText()));
        eventoDao.setEv(evenReal);
        try {
            eventoDao.actualizarEvento();
            JOptionPane.showMessageDialog(null,"Se ha cerrado el evento");
